...
print(model.wv.most_similar(positive=['司马懿', '曹丕'], negative=['曹操']))
# 设置模型参数，进行训练
...
print(model2.wv.similarity('张飞', '曹操'))
print(model2.wv.similarity('孔明', '司马懿'))
print(model2.wv.most_similar(positive=['司马懿', '曹丕'], negative=['曹操']))